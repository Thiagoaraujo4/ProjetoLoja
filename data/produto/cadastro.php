...
/*
O produto ira enviar os dados no formato json. Porém nós precisamos os dados no formato php,
 para cadastrar em banco de dados. Para realizar essa conversão iremos usar o banco json_decode.
 Assim o produto enviar os dados, este são lidos pela entrada php: e seu conteúdo é captarado e 
