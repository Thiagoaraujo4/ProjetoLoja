<?php
/* Este cabeçalho permite acesso a listagem de endereco 
...
/*
 O arquivo endereco.php foi incluido para que a classe endereco fosse utilizada. vale 
lembrar que esta classe possui o CRUD para o endereco.
 */
...
/*
Instância da classe Usuário e, portanto, criação do objeto chamado $endereco.
Isso fará com que todas as funções que estão dentro da classe Uauraio sejam transferidas
para o obejto $endereco.
...
Dentro da função listar() temos uma consulta no formato sql que seleciona todos os usuário("Select * from endereco")
*/
...
usuários. Caso contrário será exibido uma mensagem que não enderecos cadastrados.
*/

if($stmt->rowCount() > 0){

    /*
    Para organizar os enderecos cadastrados em banco e exibi-los em tela, foi criado uma array com o nome de
    saida e assim guardar todos enderecos.
    */
    ...
    */
    while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        campos da tabela enderecos.
        */

        extract($linha);
        /*
        Pegar um campo por vez do comando extract e adicionar em um array de itens, pois será assim que os enderecos
        serão  tratados, um endereco por vez com seus respectivos dados.
        */

        $array_item = array(
            "id"=>$id,
            "logradoura"=>utf8_encode($logradoura),
            "numero"=>$numero,
        ...
        ao endereco_arr[saida] um item que é um endereco com seus respectivos dados.
        */
...
/*
Pegamos o array endereco_arr que foi construido em php com os dados dos enderecos
