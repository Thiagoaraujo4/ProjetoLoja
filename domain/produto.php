...
class Produto{
    ...
    /*
    Funçao listar para selecionar todos os produtos cadastrados no banco de dados. Essa função retorna uma 
    ...
    */ 
    public function listar(){
        ...
        */
        ...
        $stmt->execute();
        #retorna os dados do produto a camada data.p
        return $stmt;
    }
...
/* 
Funçao para cadastrar os produto no banco de dados
*/
